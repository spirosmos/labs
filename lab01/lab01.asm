...
main:   # Words ending with ':' are **labels**
        ...
        la	$t3, matric	#fortwnw thn dieuthinsh tou matric ston t3
        lw 	$v0, 0($t3)	#kai pernaw thn timh toy matric ston v0
        
        #la       $a0, mesg1        # get address of mesg1 into $a0  (OI ENTOLES GIA THN ANAGNWSH AP TO PLHKTROLOGIO AFAIROYNTAI)
...
###############################################################################
        ...
        #  
matric: .word 2489    # This will be used by your submitted code
